...
The generateCalculators method generates a function for each metric with default parameters. This method is called in every calculator class to create consistent first-class functions. For the implementation and differences between calculators see Appendix \ref{appendix:slides_3}, slides 8-10.
