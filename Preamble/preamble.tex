...
%\usepackage{tabularx}
\renewcommand{\rotate}[1]{\rotatebox[origin=c]{90}{#1}}
...
\definecolor{blueish}{HTML}{4b83cd}
\definecolor{brownish}{HTML}{aa3731}
\definecolor{reddish}{HTML}{d63031}
\definecolor{codegray}{HTML}{aaaaaa}
