...
\mynote{What are the main differences between postal systems used around the globe?}
...
\mynote{talk about use cases and usefulness of geospatial data}
...
\[P = \{\langle x, y \rangle | -90 < x < 90, -180 < y < 180 \}\]
