...
In both the price calculation and the portal data mutation case, required data are stored in one or more databases.
The proposed database schema for TPS in Image 4.7.1. of Appendix \ref{appendix:pregame} shows the general structure of the data that must be stored for TPS to be operational.
